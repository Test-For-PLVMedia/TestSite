...
### [Producer](h.k6vpdgk5q6kp)

See [\[Producing\]](h.k6vpdgk5q6kp).
...
This section is for operation instructions of the software wirecast. For what you need to connect to the wirecast hardware/computer, see either the [MOAC Setup](h.saa8t5379qfj) or [BOAC Setup](h.kwhq4y8y0apo) sections. For more technical details or making a new template/title, see [MOAC - Wirecast](h.saa8t5379qfj).
...
4.  Make sure all of your crew is there and in [uniform](h.k6vpdgk5q6kp).
